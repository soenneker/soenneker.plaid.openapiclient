...
namespace Soenneker.Plaid.OpenApiClient.Models
{
    ...
    public partial class LinkTokenCreateRequestCraOptionsCashflowInsights : IAdditionalDataHolder, IParsable
    {
        ...
        /// </summary>
        public LinkTokenCreateRequestCraOptionsCashflowInsights()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Plaid.OpenApiClient.Models.LinkTokenCreateRequestCraOptionsCashflowInsights"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Plaid.OpenApiClient.Models.LinkTokenCreateRequestCraOptionsCashflowInsights CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Plaid.OpenApiClient.Models.LinkTokenCreateRequestCraOptionsCashflowInsights();
        }
        /// <summary>
