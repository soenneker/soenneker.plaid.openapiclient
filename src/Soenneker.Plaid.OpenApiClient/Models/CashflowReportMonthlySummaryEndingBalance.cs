...
namespace Soenneker.Plaid.OpenApiClient.Models
{
    ...
    public partial class CashflowReportMonthlySummaryEndingBalance : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Plaid.OpenApiClient.Models.CashflowReportMonthlySummaryEndingBalance"/> and sets the default values.
        /// </summary>
        public CashflowReportMonthlySummaryEndingBalance()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Plaid.OpenApiClient.Models.CashflowReportMonthlySummaryEndingBalance"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Plaid.OpenApiClient.Models.CashflowReportMonthlySummaryEndingBalance CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Plaid.OpenApiClient.Models.CashflowReportMonthlySummaryEndingBalance();
        }
        /// <summary>
