...
namespace Soenneker.Plaid.OpenApiClient.Models
{
    ...
    public partial class LinkTokenCreateRequestCraOptionsBaseReport : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
        ...
        public string ClientReportId { get; set; }
#endif
        /// <summary>Specifies options for initializing Link to create reports that can be shared with GSEs for mortgage verification.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Plaid.OpenApiClient.Models.LinkTokenCreateRequestCraOptionsBaseReport"/> and sets the default values.
        /// </summary>
        public LinkTokenCreateRequestCraOptionsBaseReport()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Plaid.OpenApiClient.Models.LinkTokenCreateRequestCraOptionsBaseReport"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Plaid.OpenApiClient.Models.LinkTokenCreateRequestCraOptionsBaseReport CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Plaid.OpenApiClient.Models.LinkTokenCreateRequestCraOptionsBaseReport();
        }
        /// <summary>
