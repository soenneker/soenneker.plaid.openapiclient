...
namespace Soenneker.Plaid.OpenApiClient.Models
{
    ...
    public partial class PayStubDeductionsBreakdown : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Raw amount of the deduction</summary>
        public double? CurrentAmount { get; set; }
        /// <summary>Description of the deduction line item</summary>
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Plaid.OpenApiClient.Models.PayStubDeductionsBreakdown"/> and sets the default values.
        /// </summary>
        public PayStubDeductionsBreakdown()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Plaid.OpenApiClient.Models.PayStubDeductionsBreakdown"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Plaid.OpenApiClient.Models.PayStubDeductionsBreakdown CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Plaid.OpenApiClient.Models.PayStubDeductionsBreakdown();
        }
        /// <summary>
