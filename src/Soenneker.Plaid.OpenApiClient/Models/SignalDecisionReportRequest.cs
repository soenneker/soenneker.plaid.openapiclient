...
namespace Soenneker.Plaid.OpenApiClient.Models
{
    ...
    public partial class SignalDecisionReportRequest : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
        ...
        public string Secret { get; set; }
#endif
        /// <summary>The date the ACH debit was submitted to the bank for processing (in ISO 8601 format: `YYYY-MM-DDTHH:mm:ssZ`). This field should correspond to the attempt initiated after the `/signal/schedule` call.</summary>
        public DateTimeOffset? SubmittedAt { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Plaid.OpenApiClient.Models.SignalDecisionReportRequest"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Plaid.OpenApiClient.Models.SignalDecisionReportRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Plaid.OpenApiClient.Models.SignalDecisionReportRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Plaid.OpenApiClient.Models.SignalDecisionReportRequest();
        }
        /// <summary>
